        ...
        <div class="container">
            ...
            <div class="float-right">
                <strong><i class="fa fa-globe" aria-hidden="true"></i>
                    <a href="create.php?lang=den" style="text-decoration : none; color:#fff"><?php echo $lang['danish'] ?></a> |
                    <a href="create.php?lang=en" style="text-decoration : none; color:#fff"><?php echo $lang['english'] ?></a>
                </strong>
            </div>
